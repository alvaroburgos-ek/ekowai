-- Hand-authored (Plan 2b Task 7); regenerated by the Task-5 emitter (scripts/regulation-tables/emit-widget-configs-sql.ts) once it lands — byte parity pinned there.
...
-- Scope: the HOME template only (w.code = 'A138-12'); inherited copies of the symbol on consumer worksheets keep
-- widget NULL — an inherited copy is never a producer and the widget renders it display-only regardless.
