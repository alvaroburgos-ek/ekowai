...
WHERE cr.code IN ('A138-REQ-31', 'A138-REQ-32', 'A138-REQ-33')
ORDER BY cr.code;

-- Expected output:
-- code          | severity | condition                                                      | clause_reference | worksheet_code | standard_code  | audit_status
-- A138-REQ-31   | block    | k_i > r_D_n_used * 0.0000001                                  | §6.2.2 Gl.(13)  | A138-16        | DWA-A-138-1    | (null or existing)
-- A138-REQ-32   | block    | L_VS * q_VS >= r_5_n * A_C * 0.0001                           | §6.4.2 Gl.(25)  | A138-18        | DWA-A-138-1    | (null or existing)
-- A138-REQ-33   | block    | IF shaft_type == typ_B THEN A_S_FS * k_f_FS >= A_S_Schacht * k_i | §6.7.2 Gl.(38) | A138-21        | DWA-A-138-1  | (null or existing)
