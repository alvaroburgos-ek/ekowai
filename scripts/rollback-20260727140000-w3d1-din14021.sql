-- ROLLBACK for the DIN-14021 half of the W3-D1 quote backfill.
--
-- Restores from w3d1_quote_backfill_backup, which holds the ACTUAL pre-write values.
-- It does not reconstruct them from clause_reference: several DIN-14021 stubs carried
...
BEGIN
  ...
  RAISE NOTICE 'W3-D1 DIN-14021 ROLLBACK: % CR rows restored from backup', v_reverted;
END $$;
