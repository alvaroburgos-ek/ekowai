...
const annexEntries = (): FieldConfigEntry[] => {
  ...
  return [
    ...
    on('M8203-22')({ symbol: 'projektstopp_code_a', widget: 'derived', ui_config: null, visible_when: ANNEX_A, verification_quote: norm(Q_L307),
      create: { section_code: 'D', label_de: 'Projektstopp-Prüfung erforderlich (Anhang A) — 1, wenn ein Phasenziel §5.2 / §5.3 / §5.4 „nicht erreicht“ ist', data_type: 'number', unit: null, clause_reference: '§3; §5.2–5.4', description: 'Plan 3: Ausgabe der Gleichung M8203-22-D3 (OR über die 13 pz_52_* / pz_53_* / pz_54_*-Status == nicht_erreicht, alle auf M8203-22 vererbt); REQ-31 (leere Bedingung) darauf STAGED (m820_3-G-4).' } }),
    ...
    on('M8203-23')({ symbol: 'projektstopp_code_b', widget: 'derived', ui_config: null, visible_when: ANNEX_B, verification_quote: norm(Q_L307),
      create: { section_code: 'D', label_de: 'Projektstopp-Prüfung erforderlich (Anhang B) — 1, wenn ein Phasenziel §6.2 … §6.7 „nicht erreicht“ ist', data_type: 'number', unit: null, clause_reference: '§3; §6.2–6.7', description: 'Plan 3: Ausgabe der Gleichung M8203-23-D3 (OR über die 54 pz_62_* … pz_67_*-Status == nicht_erreicht, alle auf M8203-23 vererbt); REQ-31 darauf STAGED (m820_3-G-4).' } }),
    on('M8203-24')({ symbol: 'projektstopp_code', widget: 'derived', ui_config: null, verification_quote: norm(Q_L307),
      create: { section_code: 'F', label_de: 'Projektstopp-Prüfung erforderlich — 1, wenn irgendein Phasenziel (Anhang A oder B) „nicht erreicht“ ist', data_type: 'number', unit: null, clause_reference: '§3', description: 'Plan 3: Ausgabe der Gleichung M8203-24-D1 (OR über alle 67 pz_*_status == nicht_erreicht, alle auf M8203-24 vererbt; jedes Phasenziel muss gesetzt sein — nicht zutreffende Phasen als nicht_zutreffend); die Booleans projektstopp_review_triggered (M8203-02) / projektstopp_required bleiben Eingaben, REQ-31 darauf STAGED (m820_3-G-4).' } }),
  ];
};
