...
export const S6_LIMITS_ROWS: ReadonlyArray<TextRow> = [
  ...
  { parameter: 'n_rbf_min', label_de: 'Beschickungshäufigkeit im langjährigen Mittel (gedruckt „≥ 10 a“; §3.2 druckt n_RBF in 1/a — a178-U-5)', wert: 10, unit: 'a', comparator: '≥', modal: 'muss', printed: '$\\geq 10$ a sein', line: 'L979' }, // unit as PRINTED (fix round 1); the §3.2 symbol table (L354) and prod n_RBF carry 1/a — a178-U-5
