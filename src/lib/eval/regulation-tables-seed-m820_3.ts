...
export type QeItem = { nr: string; nr_num: number; group: string | null; kriterium: string; hinweise: string; quote: string; lines: string };
...
export const QE_A1_ITEMS: readonly QeItem[] = [
  { nr: "n1", nr_num: 1, group: null, kriterium: "Ist-Zustand und Zielsetzung formulieren", hinweise: "Aussagen zu Technik, Ökonomie, Ökologie und Termine", lines: "L689",
    quote: "\\hline 1 & Ist-Zustand und Zielsetzung formulieren & Aussagen zu Technik, Ökonomie, Ökologie und Termine \\\\" },
  { nr: "n2", nr_num: 2, group: null, kriterium: "Rahmenbedingungen beschreiben (z. B. Bauleitplanung, Landschaft, Artenschutz, Boden, Nachhaltigkeit), Anlass aufzeigen, Genehmigungssituation", hinweise: "Vorhandene Genehmigungen, Liegenschaftsvereinbarung siehe auch Anhang A. 4 ., QE 5.5 - Matrix Nachhaltigkeit\"", lines: "L690",
  ...
  { nr: "n3", nr_num: 3, group: null, kriterium: "Prognoseentwicklung/Stadtentwicklung (Einzugsgebiet, Wassermengen Klimaveränderung etc.), Prognosezeitraum", hinweise: "Übergreifende Abstimmung", lines: "L691",
  ...
  { nr: "n4", nr_num: 4, group: null, kriterium: "Anforderungen der Aufsichtsbehörden, Entwicklung von technischen Anforderungen", hinweise: "Behördenabstimmung", lines: "L692",
    quote: "\\hline 4 & Anforderungen der Aufsichtsbehörden, Entwicklung von technischen Anforderungen & Behördenabstimmung \\\\" },
  { nr: "n5", nr_num: 5, group: null, kriterium: "Untersuchungsbereich/Schnittstellen definieren", hinweise: "Übersichtsplan, Systemskizze", lines: "L693",
    quote: "\\hline 5 & Untersuchungsbereich/Schnittstellen definieren & Übersichtsplan, Systemskizze \\\\" },
  { nr: "n6", nr_num: 6, group: null, kriterium: "Zur Verfügung stehende Unterlagen und Daten (Bestand, Betriebsdaten) definieren (Formate, Qualität, Aktualität etc.), vorliegende Untersuchungen, Belastungsgrößen", hinweise: "Liste zur Verfügung stehender Unterlagen, Metadaten", lines: "L694",
  ...
  { nr: "n7", nr_num: 7, group: null, kriterium: "Werkzeuge (Berechnungsmethoden, Softwareeinsatz, Verfahren)", hinweise: "Listen der einzusetzenden Software inkl. Versionen", lines: "L695",
    quote: "\\hline 7 & Werkzeuge (Berechnungsmethoden, Softwareeinsatz, Verfahren) & Listen der einzusetzenden Software inkl. Versionen \\\\" },
  { nr: "n8", nr_num: 8, group: null, kriterium: "Bearbeitungstiefe", hinweise: "", lines: "L696",
    quote: "\\hline 8 & Bearbeitungstiefe & \\\\" },
  { nr: "n9", nr_num: 9, group: null, kriterium: "Konzeptbezogene Organisation AG, Zuständigkeiten, beteiligte Fachplaner", hinweise: "Organigramm, Projektorganisation, Projektbeteiligtenliste", lines: "L697",
  ...
  { nr: "n11", nr_num: 11, group: null, kriterium: "Definition von Projekten, Genehmigungsanforderungen und Prioritätenlisten, Terminrahmen", hinweise: "Rahmenterminplan", lines: "L702",
    quote: "\\hline 11 & Definition von Projekten, Genehmigungsanforderungen und Prioritätenlisten, Terminrahmen & Rahmenterminplan \\\\" },
  { nr: "n12", nr_num: 12, group: null, kriterium: "Aufbereitung / Übergabe von Ergebnissen", hinweise: "Dokumentenbedarfsliste", lines: "L703",
    quote: "\\hline 12 & Aufbereitung / Übergabe von Ergebnissen & Dokumentenbedarfsliste \\\\" },
  { nr: "n13", nr_num: 13, group: null, kriterium: "Prüfungs- und Freigabeprozesse", hinweise: "Berücksichtigung in Rahmenterminplan, Schema Prozessablauf", lines: "L704–L707",
    quote: "\\hline 13 & Prüfungs- und Freigabeprozesse & \\begin{tabular}{l}\nBerücksichtigung in Rahmenterminplan, \\\\\nSchema Prozessablauf\n\\end{tabular} \\\\" },
  { nr: "n14", nr_num: 14, group: null, kriterium: "Kommunikation, Abstimmungsprozesse", hinweise: "Form, Häufigkeit, Werkzeuge", lines: "L708",
    quote: "\\hline 14 & Kommunikation, Abstimmungsprozesse & Form, Häufigkeit, Werkzeuge \\\\" },
  { nr: "n15", nr_num: 15, group: null, kriterium: "Anwendung DIN 18205", hinweise: "Checklisten", lines: "L709",
...
export const QE_A2_ITEMS: readonly QeItem[] = [
  { nr: "n1", nr_num: 1, group: null, kriterium: "Zielstellung formulieren, Verifizierung vor dem Hintergrund behördlicher und technischer Anforderungen und Prognoseentwicklung", hinweise: "Konkretisierung der Bedarfsplanung", lines: "L717",
  ...
  { nr: "n2", nr_num: 2, group: null, kriterium: "Unterziele formulieren", hinweise: "", lines: "L718",
    quote: "\\hline 2 & Unterziele formulieren & \\\\" },
  { nr: "n3", nr_num: 3, group: null, kriterium: "Darstellung des IST-Systems, qualitätsgesicherte Bestandsdaten", hinweise: "Quellen, Metadaten", lines: "L719",
    quote: "\\hline 3 & Darstellung des IST-Systems, qualitätsgesicherte Bestandsdaten & Quellen, Metadaten \\\\" },
  { nr: "n4", nr_num: 4, group: null, kriterium: "Verständnis der wasserwirtschaftlichen Zusammenhänge", hinweise: "Systembeschreibung, System-(Fließ-)Schemata", lines: "L720",
    quote: "\\hline 4 & Verständnis der wasserwirtschaftlichen Zusammenhänge & Systembeschreibung, System-(Fließ-)Schemata \\\\" },
  { nr: "n5", nr_num: 5, group: null, kriterium: "Darstellung von Flächenverfügbarkeiten", hinweise: "Karten mit Eigentumsverhältnissen", lines: "L721",
    quote: "\\hline 5 & Darstellung von Flächenverfügbarkeiten & Karten mit Eigentumsverhältnissen \\\\" },
  { nr: "n6", nr_num: 6, group: null, kriterium: "Entwicklung von realisierbaren Maßnahmen, Untersuchung von Alternativen nach grundsätzlich verschiedenen Anforderungen, Synergieeffekte und Schnittstellen", hinweise: "", lines: "L722",
  ...
  { nr: "n7", nr_num: 7, group: null, kriterium: "Bewertung der Maßnahmen und Erstellung einer Prioritätenliste", hinweise: "Bewertungsmatrix (im Planungsteam abgestimmt und freigegeben)", lines: "L723",
  ...
  { nr: "n8", nr_num: 8, group: null, kriterium: "Klärung von Subventionen/Fördermitteln/Finanzierungen", hinweise: "", lines: "L724",
...
export const QE_A3_ITEMS: readonly QeItem[] = [
  { nr: "n1", nr_num: 1, group: null, kriterium: "Projektauftrag (als Basis für die Bedarfsplanung des Projekts)", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L732",
  ...
  { nr: "n2", nr_num: 2, group: null, kriterium: "Hintergrund, Veranlassung", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L733",
    quote: "\\hline 2 & Hintergrund, Veranlassung & \\\\" },
  { nr: "n3", nr_num: 3, group: null, kriterium: "Problembeschreibung", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L734",
    quote: "\\hline 3 & Problembeschreibung & \\\\" },
  { nr: "n4", nr_num: 4, group: null, kriterium: "Ziele", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L735",
    quote: "\\hline 4 & Ziele & \\\\" },
  { nr: "n5", nr_num: 5, group: null, kriterium: "Dringlichkeit", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L736",
    quote: "\\hline 5 & Dringlichkeit & \\\\" },
  { nr: "n6", nr_num: 6, group: null, kriterium: "im Projektumgriff (..In Scope\") / Schnittstellen", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L737",
    quote: "\\hline 6 & im Projektumgriff (..In Scope\") / Schnittstellen & \\\\" },
  { nr: "n7", nr_num: 7, group: null, kriterium: "nicht im Projektumgriff (..Out of Scope\")", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L738",
    quote: "\\hline 7 & nicht im Projektumgriff (..Out of Scope\") & \\\\" },
  { nr: "n8", nr_num: 8, group: null, kriterium: "Besonderheiten", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L739",
    quote: "\\hline 8 & Besonderheiten & \\\\" },
  { nr: "n9", nr_num: 9, group: null, kriterium: "Budget", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L740",
    quote: "\\hline 9 & Budget & \\\\" },
  { nr: "n10", nr_num: 10, group: null, kriterium: "Vorläufiger Rahmenterminplan", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L741",
    quote: "\\hline 10 & Vorläufiger Rahmenterminplan & \\\\" },
  { nr: "n11", nr_num: 11, group: null, kriterium: "Projektleitung/Kümmerer", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L742",
    quote: "\\hline 11 & Projektleitung/Kümmerer & \\\\" },
  { nr: "n12", nr_num: 12, group: null, kriterium: "Ressourcen (Personal etc.)", hinweise: "Kurzbeschreibungen zur Identifikation von Projekten aus dem Konzept", lines: "L743",
...
export const QE_A4_ITEMS: readonly QeItem[] = [
  { nr: "n1", nr_num: 1, group: null, kriterium: "Ökonomie/Wirtschaftlichkeit", hinweise: "Minimierung der Lebenszykluskosten im Konzept/Projekt · Datenverwendung über den Lebenszyklus der Bauwerke", lines: "L752–L753", // Nr. cell printed EMPTY (m820_3-U-1) — positional
  ...
  { nr: "n2", nr_num: 2, group: null, kriterium: "Ökologie/Umwelt", hinweise: "Minimierung der ökologischen Auswirkungen ( CO2, Klimabilanz etc.) · Ökologische Eingriffe, Ausgleichsmaßnahmen · Artenschutz", lines: "L754–L756",
  ...
  { nr: "n3", nr_num: 3, group: null, kriterium: "Sozioökonomie/Gesellschaft", hinweise: "Wirkung auf Gesellschaft · Lärm, Verkehr", lines: "L757–L758", // Nr. cell printed EMPTY (m820_3-U-1) — positional
...
export const QE_B1_ITEMS: readonly QeItem[] = [
  { nr: "n1", nr_num: 1, group: null, kriterium: "Projektbeschreibung, Rahmenbedingungen, Festlegung von Qualitäts-, Umwelt- und Nachhaltigkeitszielen", hinweise: "Berücksichtigung QE 5.4 Identifikation Projekte; Projekthandbuch", lines: "L769",
  ...
  { nr: "n2", nr_num: 2, group: null, kriterium: "Genehmigungssituation, Anforderungen der Aufsichtsbehörden, Zielsetzung", hinweise: "Vorhandene Genehmigungen, Behördenabstimmung", lines: "L770",
  ...
  { nr: "n3", nr_num: 3, group: null, kriterium: "Abgrenzbare Funktionsbereiche, Leistungspakete definieren", hinweise: "Auch zur Festlegung von Schnittstellen, zunächst unabhängig von Honorarordnungen, Bedarf an Leistungen feststellen", lines: "L771",
  ...
  { nr: "n4", nr_num: 4, group: null, kriterium: "Beschreibung der Grundleistungen / besondere Leistungen, Leistungen des AG definieren, Vergabeeinheiten festlegen", hinweise: "Grundlagen sind Strukturen, bspw. der HOAI, des AHO", lines: "L772",
  ...
  { nr: "n5", nr_num: 5, group: null, kriterium: "Vorhandene Grundlagen (Bestandspläne etc.) bewerten (Qualität, Verwendbarkeit)", hinweise: "Liste zur Verfügung stehender Unterlagen, Metadaten", lines: "L773",
  ...
  { nr: "n6", nr_num: 6, group: null, kriterium: "Zu erarbeitende Grundlagen festlegen (Vermessung, Bestandspläne etc.) inklusive Zeitbedarf", hinweise: "Rahmenterminplan, Leistungserbringende", lines: "L774",
  ...
  { nr: "n7", nr_num: 7, group: null, kriterium: "Untersuchung von Alternativen nach grundsätzlich verschiedenen Anforderungen", hinweise: "In Abgrenzung zur Vorplanung (Varianten = Alternativen nach grundsätzlich gleichen Anforderungen)", lines: "L775",
  ...
  { nr: "n8", nr_num: 8, group: null, kriterium: "Kostenrahmen, Rahmenterminplan", hinweise: "Kostenschärfe auf zweiter Ebene der Kostengruppen nach DIN 276, Rahmenterminplan", lines: "L776",
  ...
  { nr: "n9", nr_num: 9, group: null, kriterium: "Finanzierung, Fördermittel", hinweise: "Bedarfsgenehmigung durch Finanzierungsstelle", lines: "L777",
    quote: "\\hline 9 & Finanzierung, Fördermittel & Bedarfsgenehmigung durch Finanzierungsstelle \\\\" },
  { nr: "n10", nr_num: 10, group: null, kriterium: "Organisation AG, beteiligte Stellen, Entscheidungswege, Entscheidungs- und Freigabeprozesse, Weisungsbefugnisse", hinweise: "Organigramm, Projektorganisation, Projektbeteiligtenliste, Schema Prozessablauf, Funktionenmatrix", lines: "L785",
  ...
  { nr: "n11", nr_num: 11, group: null, kriterium: "Kommunikationskonzept (Form, Wege, Häufigkeit)", hinweise: "Form und Häufigkeit (Definition im Projekthandbuch)", lines: "L786",
    quote: "\\hline 11 & Kommunikationskonzept (Form, Wege, Häufigkeit) & Form und Häufigkeit (Definition im Projekthandbuch) \\\\" },
  { nr: "n12", nr_num: 12, group: null, kriterium: "Festlegung der Planungsmethodik und der Planungswerkzeuge", hinweise: "2D / 3D / BIM, eDMS", lines: "L787",
    quote: "\\hline 12 & Festlegung der Planungsmethodik und der Planungswerkzeuge & 2D / 3D / BIM, eDMS \\\\" },
  { nr: "n13", nr_num: 13, group: null, kriterium: "Datenaustauch, Struktur", hinweise: "Listen der einzusetzenden Software inkl. Versionen, Datenaustauschplattform mit Ablagestruktur", lines: "L788–L791",
  ...
  { nr: "n15", nr_num: 15, group: null, kriterium: "Anwendung DIN 18205 - Bedarfsplanung", hinweise: "Checklisten", lines: "L793",
...
export const QE_B2_ITEMS: readonly QeItem[] = [
  ...
  { nr: "n3", nr_num: 3, group: "Grundlagenermittlung", kriterium: "Pflichtenhefte sind vom AG übergeben worden und akzeptiert", hinweise: "Formatvorlagen sind nach Auftraggebervorgaben festgelegt und abgestimmt. Zuweisungen Farben, Maßeinheiten oder Kürzel sind erfolgt", lines: "L804",
  ...
  { nr: "n4", nr_num: 4, group: "Grundlagenermittlung", kriterium: "Projekthandbuch (Regelungen für die Projektabwicklung) ist erstellt und verabschiedet", hinweise: "", lines: "L805",
    quote: "\\hline 4 & Projekthandbuch (Regelungen für die Projektabwicklung) ist erstellt und verabschiedet & \\\\" },
  { nr: "n5", nr_num: 5, group: "Grundlagenermittlung", kriterium: "Fachlich Beteiligte sind frühzeitig vertraglich gebunden. Die Schnittstellen sind geklärt, die Aufgaben festgelegt", hinweise: "u. a. Brandschutz, Schadstoffsanierung, Landschafts-/Artenschutz, Ex-Schutz", lines: "L806",
  ...
  { nr: "n6", nr_num: 6, group: "Grundlagenermittlung", kriterium: "Analysen von Studien und hydraulischen Berechnungen sind erfolgt", hinweise: "", lines: "L807",
    quote: "\\hline 6 & Analysen von Studien und hydraulischen Berechnungen sind erfolgt & \\\\" },
  { nr: "n7", nr_num: 7, group: "Grundlagenermittlung", kriterium: "Die Bedarfsplanung liegt vor, wird analysiert und verstanden", hinweise: "Vorgaben und ggf. Studien des AG sind eingearbeitet", lines: "L808",
  ...
  { nr: "n9", nr_num: 9, group: "Grundlagenermittlung", kriterium: "Lastfälle und Ziele sind geklärt", hinweise: "", lines: "L818",
    quote: "\\hline 9 & Lastfälle und Ziele sind geklärt & \\\\" },
  { nr: "n10", nr_num: 10, group: "Grundlagenermittlung", kriterium: "Konsistente Bestandsdaten sind verfügbar", hinweise: "", lines: "L819",
    quote: "\\hline 10 & Konsistente Bestandsdaten sind verfügbar & \\\\" },
  { nr: "n11", nr_num: 11, group: "Grundlagenermittlung", kriterium: "Bauen im Bestand: Besonderheiten des Bestands sind berücksichtigt", hinweise: "Risikoanalysen, Untersuchungsumfang festlegen, Absichern relevanter Aspekte für die Planung und Ausführung, Qualität Bestandsdaten", lines: "L820",
  ...
  { nr: "n12", nr_num: 12, group: "Grundlagenermittlung", kriterium: "Ermitteln der Planungsrandbedingungen", hinweise: "bspw. Denkmalschutz, Bauleitplanung, Geologie, Grundstücksverhältnisse, Nachbarbebauung, Schutzzonen, Kampfmittel, Altlasten, Schadstoffe etc.", lines: "L821",
  ...
  { nr: "n13", nr_num: 13, group: "Grundlagenermittlung", kriterium: "Leistungsphase wird abgeschlossen und durch AG genehmigt", hinweise: "Bericht zur Grundlagenermittlung", lines: "L822",
    quote: "\\hline 13 & Leistungsphase wird abgeschlossen und durch AG genehmigt & Bericht zur Grundlagenermittlung \\\\" },
  { nr: "n14", nr_num: 14, group: "Vorplanung", kriterium: "Bestand ist umfassend bekannt und erfasst", hinweise: "Noch zu ergänzende Bestandsdaten werden nacherfasst und ergänzt", lines: "L824",
    quote: "\\hline 14 & Bestand ist umfassend bekannt und erfasst & Noch zu ergänzende Bestandsdaten werden nacherfasst und ergänzt \\\\" },
  { nr: "n15", nr_num: 15, group: "Vorplanung", kriterium: "Finale Festlegung der Bemessungsgrößen", hinweise: "Dynamische, zeitabhängige Größen, Bezugszeitraum wird festgelegt", lines: "L825",
    quote: "\\hline 15 & Finale Festlegung der Bemessungsgrößen & Dynamische, zeitabhängige Größen, Bezugszeitraum wird festgelegt \\\\" },
  { nr: "n16", nr_num: 16, group: "Vorplanung", kriterium: "Lösungsansätze (nach grundsätzlich gleichen Anforderungen) umfassend untersucht", hinweise: "Erwartungsabgleich zwischen Planer und AG", lines: "L826",
  ...
  { nr: "n17", nr_num: 17, group: "Vorplanung", kriterium: "Zielführende Varianten identifizieren und bewerten", hinweise: "Ausschlusskriterien, mehrere machbare Varianten", lines: "L827",
    quote: "\\hline 17 & Zielführende Varianten identifizieren und bewerten & Ausschlusskriterien, mehrere machbare Varianten \\\\" },
  { nr: "n18", nr_num: 18, group: "Vorplanung", kriterium: "Vorzugsvariante erfüllt alle Anforderungen", hinweise: "Bewertungskriterien zur Identifikation der Vorzugsvariante wurden abgestimmt; die Akzeptanz der Öffentlichkeit oder die Öffentlichkeitsarbeit kann ein Kriterium sein", lines: "L828",
  ...
  { nr: "n19", nr_num: 19, group: "Vorplanung", kriterium: "Dokumentation der Entscheidungsfindung ist aktuell geführt", hinweise: "Bei einem Wechsel von Projektbeteiligten besteht Entscheidungssicherheit zur reibungslosen Fortführung", lines: "L829",
  ...
  { nr: "n20", nr_num: 20, group: "Vorplanung", kriterium: "Flächenverfügbarkeiten, inkl. temporärer Inanspruchnahme für Baustelleneinrichtung etc. sind geklärt", hinweise: "Für Vorzugsvariante geklärt; inkl. Durchleitungsrechte", lines: "L830",
  ...
  { nr: "n21", nr_num: 21, group: "Vorplanung", kriterium: "Leistungsphase wird abgeschlossen und durch AG genehmigt", hinweise: "Bericht zur Vorplanung, inkl. Erläuterung und Freigabe", lines: "L831",
  ...
  { nr: "n22", nr_num: 22, group: "Entwurfsplanung", kriterium: "Schnittstelle zwischen EMSR, Automatisie-rungs- und Maschinentechnik geklärt", hinweise: "", lines: "L833",
    quote: "\\hline 22 & Schnittstelle zwischen EMSR, Automatisie-rungs- und Maschinentechnik geklärt & \\\\" },
  { nr: "n23", nr_num: 23, group: "Entwurfsplanung", kriterium: "Kostenberechnung", hinweise: "Kosten müssen abgestimmt sein, Berücksichtigung Kostenträger, Fördermittel, Verrechnung mit Abwasserabgabe Die Kosten sind ausreichend detailliert, um alle berücksichtigten Elemente erkennen zu können. Kostengliederung nach DIN 276 ist berücksichtigt", lines: "L843–L846",
  ...
  { nr: "n24", nr_num: 24, group: "Entwurfsplanung", kriterium: "Bauzeiten- und Kostenplan", hinweise: "Wesentliche Bauphasen, Verkehrslenkung, Provisorien, Berücksichtigung von Ressourcen", lines: "L847",
  ...
  { nr: "n25", nr_num: 25, group: "Entwurfsplanung", kriterium: "Betriebliche Aspekte, Provisorien, Außerund Inbetriebnahmen sind berücksichtigt und geplant Einflüsse auf Bauzeiten- und Kostenplan sind eingearbeitet", hinweise: "Bauzustände, Zwischenzustände, Wasserhaltung etc.", lines: "L848–L851",
  ...
  { nr: "n26", nr_num: 26, group: "Entwurfsplanung", kriterium: "Betriebliche Zwischenzustände sind geplant", hinweise: "Es ist geklärt, wer welche Leistungen übernimmt (bspw. inwieweit wirkt der Betrieb mit, welche Leistungen werden ausgeschrieben etc.)", lines: "L852",
  ...
  { nr: "n27", nr_num: 27, group: "Entwurfsplanung", kriterium: "Entscheidungsdokumentation", hinweise: "Entscheidungen vom AG werden begründet und transparent dargestellt", lines: "L853",
    quote: "\\hline 27 & Entscheidungsdokumentation & Entscheidungen vom AG werden begründet und transparent dargestellt \\\\" },
  { nr: "n28", nr_num: 28, group: "Entwurfsplanung", kriterium: "Entwurfsplanung ist genehmigungsfähig und baubar", hinweise: "Die Ausführungsplanung detailliert die Entwurfsplanung, ändert diese jedoch nicht mehr", lines: "L854",
  ...
  { nr: "n29", nr_num: 29, group: "Entwurfsplanung", kriterium: "Entwurfsplanung ist genehmigungsfähig und baubar", hinweise: "Nach Bedarf werden einzelne Zwischenstände und in jedem Fall die Planungsergebnisse mit allen Beteiligten (auch genehmigende Stellen) besprochen", lines: "L855",
  ...
  { nr: "n30", nr_num: 30, group: "Entwurfsplanung", kriterium: "Budget für das Gesamtprojekt und die jährlichen Mittelbedarfsplanungen werden freigegeben", hinweise: "Verpflichtungsermächtigung, Jahresplanungen", lines: "L856",
  ...
  { nr: "n32", nr_num: 32, group: "Entwurfsplanung", kriterium: "SiGeKo ist im Projekt und arbeitet im Entwurf zu", hinweise: "Bauphasen, gemeinsame Nutzung von Baubehelfen", lines: "L858",
    quote: "\\hline 32 & SiGeKo ist im Projekt und arbeitet im Entwurf zu & Bauphasen, gemeinsame Nutzung von Baubehelfen \\\\" },
  { nr: "n33", nr_num: 33, group: "Entwurfsplanung", kriterium: "Das Änderungsmanagement ist aufgesetzt und wird konsequent genutzt", hinweise: "", lines: "L859",
    quote: "\\hline 33 & Das Änderungsmanagement ist aufgesetzt und wird konsequent genutzt & \\\\" },
  { nr: "n34", nr_num: 34, group: "Entwurfsplanung", kriterium: "Leistungsphase wird abgeschlossen und durch AG genehmigt", hinweise: "Bericht zur Entwurfsplanung; die Freigabe der Entwurfsplanung wird auch vom Betrieb getragen", lines: "L860",
  ...
  { nr: "n35", nr_num: 35, group: "Entwurfsplanung", kriterium: "Konzept für eine Öffentlichkeitsarbeit ist erstellt und wird konsequent verfolgt", hinweise: "Abhängig von den Maßnahmen und der Art der Beeinflussung der Öffentlichkeit", lines: "L861",
  ...
  { nr: "n36", nr_num: 36, group: "Genehmigungsplanung (inkl. Genehmigungsverfahren)", kriterium: "Vorabinformation der Behörden über den vorgesehenen Umfang", hinweise: "Schriftliche Form oder Präsentation, je nach Projektgröße und Maßnahmenumfang Die Form kann mit den Behörden besprochen werden Form der Öffentlichkeitsarbeit vorbesprechen", lines: "L872–L875",
  ...
  { nr: "n37", nr_num: 37, group: "Genehmigungsplanung (inkl. Genehmigungsverfahren)", kriterium: "Anforderungen aus der Genehmigung in Form von Auflagen und Nebenbestimmungen werden eingearbeitet", hinweise: "Die Anforderungen der Behörden an Konzepte, Berichte, Logistikkonzept; Materialanlieferung und entsorgung, Beeinträchtigungen durch Baustellenverkehr etc. wurden planerisch berücksichtigt und eingearbeitet", lines: "L876",
  ...
  { nr: "n39", nr_num: 39, group: "Genehmigungsplanung (inkl. Genehmigungsverfahren)", kriterium: "Risiko der Wiederholungsleistung ist abgeschätzt worden, falls parallel zum Genehmigungsverfahren die Ausführungsplanung begonnen wird. Der Umgang damit ist vereinbart", hinweise: "", lines: "L878",
  ...
  { nr: "n40", nr_num: 40, group: "Genehmigungsplanung (inkl. Genehmigungsverfahren)", kriterium: "Eventuelle Einsprüche zum Genehmigungsbescheid sind geklärt", hinweise: "Klageverfahren, betroffene Bürger, Behörden etc.", lines: "L879",
...
export const QE_B3_ITEMS: readonly QeItem[] = [
  ...
  { nr: "n2", nr_num: 2, group: "Ausführungsplanung", kriterium: "Materialien sind eindeutig festgelegt. Anforderungen an Maschinen- und Verfahrenstechnik sind produktneutral formuliert", hinweise: "", lines: "L891",
  ...
  { nr: "n3", nr_num: 3, group: "Ausführungsplanung", kriterium: "Einbindung SiGeKo in die Ausführungplanung", hinweise: "Erschwernisse bei der Ausführung, Leitungen, Flächenbedarf (Anforderung Arbeits- und Gesundheitsschutz), Baustellenordnung, Gefährdungsbeurteilung", lines: "L892",
  ...
  { nr: "n4", nr_num: 4, group: "Ausführungsplanung", kriterium: "Bauablaufplanung, inkl. Berücksichtigung der Bau- und Betriebszustände wird aufgestellt. Daraus resultierende Anforderungen an die Ausführungsplanung sind implementiert", hinweise: "Erschwernisse, Provisorien, Einhausungen berücksichtigt, evtl. Maßnahmen vorab", lines: "L902",
  ...
  { nr: "n5", nr_num: 5, group: "Ausführungsplanung", kriterium: "Verkehrslenkungskonzept, inkl. ÖPNV etc. ist erarbeitet und fließt ein", hinweise: "Übergeordnetes Konzept ist erstellt Zuwegung ist mit der Verkehrsbehörde abgestimmt", lines: "L903–L906",
  ...
  { nr: "n6", nr_num: 6, group: "Ausführungsplanung", kriterium: "Baulogistik, Erschließung, Energieverfügbarkeit, An- und Abtransporte etc. sind geplant", hinweise: "Baustellenlogistikkonzept", lines: "L907",
  ...
  { nr: "n7", nr_num: 7, group: "Ausführungsplanung", kriterium: "Alle Fachplanungen sowie Planungen Dritter (bspw. für parallele Straßenbaumaßnahmen, für überlagernde parallele Projekte auf dem Betriebsgelände) sind auf dem aktuellen Stand und in die Ausführungsplanung integriert", hinweise: "Sicherstellen, dass alle parallelen Planungen für weitere Projekte, die Schnittstellen aufweisen, aufeinander abgestimmt sind Freigegebene Schnittstellenliste ist vorhanden", lines: "L908–L911",
  ...
  { nr: "n8", nr_num: 8, group: "Ausführungsplanung", kriterium: "Vergabepakete/Vergabeeinheiten für die Ausführung werden nach den Projektanforderungen gebildet oder bei Änderungen fortgeschrieben", hinweise: "bspw. EU-weite Ausschreibung, Lose", lines: "L912",
  ...
  { nr: "n11", nr_num: 11, group: "Ausführungsplanung", kriterium: "Prüfung Planunterlagen auf Übereinstimmung mit den Normvorgaben und den auftraggeberspezifischen Richtlinien", hinweise: "", lines: "L921",
  ...
  { nr: "n12", nr_num: 12, group: "Ausführungsplanung", kriterium: "Kontinuierliches Fortschreiben der Kostenberechnung auf der Grundlage des aktuellen Stands der Ausführungsplanung Überprüfen der Haushaltsansätze und der Budgets", hinweise: "Veränderungen werden erfasst Budgetabgleich ist möglich Eventuell vorgesehene Eigenleistungen, die zu Fremdleistungen werden, sind berücksichtigt etc.", lines: "L922–L926",
  ...
  { nr: "n13", nr_num: 13, group: "Ausführungsplanung", kriterium: "Kontinuierliches Fortschreiben der Terminpläne, um Veränderungen einzuarbeiten", hinweise: "Auch die vorlaufenden Arbeiten sind berücksichtigt; Zeitfenster für Artenschutzmaßnahmen sind eingearbeitet", lines: "L927",
  ...
  { nr: "n14", nr_num: 14, group: "Ausführungsplanung", kriterium: "Freigabeprozess ist implementiert und wird formal durchlaufen Die Ausführungsplanung ist damit bauherrenseitig anerkannt und freigegeben", hinweise: "Reduzierung von Änderungen", lines: "L928–L931",
  ...
  { nr: "n16", nr_num: 16, group: "Ausführungsplanung", kriterium: "Die Ressourcenplanung für die Inbetriebnahme (inkl. Qualifikationen) seitens der ausführenden Unternehmen wird vorbereitet und ist weitere Grundlage für die Ausschreibung", hinweise: "Die Ausarbeitung des Inbetriebnahmeorganigramms wird vom Bauherrn im Rahmen der Ausführung, rechtzeitig vor Inbetriebnahme, festgelegt", lines: "L948",
  ...
  { nr: "n18", nr_num: 18, group: "Vorbereiten der Vergabe", kriterium: "Vergabeeinheitsstruktur und Vergabekriterien (Eignungs- und Zuschlagskriterien) sind zu Beginn LPH 6 festgelegt", hinweise: "", lines: "L951",
  ...
  { nr: "n19", nr_num: 19, group: "Vorbereiten der Vergabe", kriterium: "Vergabebudgets sind gebildet", hinweise: "Grundlage: i. d. R. bepreiste Leistungsverzeichnisse", lines: "L952",
    quote: "\\hline 19 & Vergabebudgets sind gebildet & Grundlage: i. d. R. bepreiste Leistungsverzeichnisse \\\\" },
  { nr: "n20", nr_num: 20, group: "Vorbereiten der Vergabe", kriterium: "Vergabearten werden den aktuellen Vergaberegeln und den Projektanforderungen entsprechend festgelegt", hinweise: "", lines: "L953",
    quote: "\\hline 20 & Vergabearten werden den aktuellen Vergaberegeln und den Projektanforderungen entsprechend festgelegt & \\\\" },
  { nr: "n21", nr_num: 21, group: "Vorbereiten der Vergabe", kriterium: "Der Vergabeterminplan ist sorgfältig erstellt und abgestimmt, auch mit den Entscheidungsgremienterminen", hinweise: "", lines: "L954",
    quote: "\\hline 21 & Der Vergabeterminplan ist sorgfältig erstellt und abgestimmt, auch mit den Entscheidungsgremienterminen & \\\\" },
  { nr: "n22", nr_num: 22, group: "Vorbereiten der Vergabe", kriterium: "Eignungskriterien werden transparent und passend zu den Projektanforderungen festgelegt", hinweise: "", lines: "L955",
    quote: "\\hline 22 & Eignungskriterien werden transparent und passend zu den Projektanforderungen festgelegt & \\\\" },
  { nr: "n23", nr_num: 23, group: "Vorbereiten der Vergabe", kriterium: "Ob und ggf. in welchen Bereichen Nebenangebote zugelassen werden können, ist im Vorfeld zu klären und in den Vergabeunterlagen festgelegt", hinweise: "", lines: "L956",
  ...
  { nr: "n24", nr_num: 24, group: "Vorbereiten der Vergabe", kriterium: "Im Bauvertrag wird geregelt, wer die erforderlichen Anpassungen der Ausführungsplanung anhand der Werk- und Montagepläne vornimmt", hinweise: "Klarstellung im LV, ggf. Schnittstelle festlegen und regeln", lines: "L957",
  ...
  { nr: "n25", nr_num: 25, group: "Vorbereiten der Vergabe", kriterium: "Hinweis auf Erschwernisse bei der Ausführung sind im LV enthalten", hinweise: "Kalkulationsrelevante Informationen sind dem Bieter bekannt", lines: "L958",
  ...
  { nr: "n26", nr_num: 26, group: "Vorbereiten der Vergabe", kriterium: "Einbindung SiGeKo in die Ausschreibungsunterlagen", hinweise: "", lines: "L959",
    quote: "\\hline 26 & Einbindung SiGeKo in die Ausschreibungsunterlagen & \\\\" },
  { nr: "n27", nr_num: 27, group: "Vorbereiten der Vergabe", kriterium: "Die Transparenz der Ausschreibungsunterlagen ist gegeben Die Vergabekriterien sind eindeutig und nachvollziehbar", hinweise: "", lines: "L969–L972",
  ...
  { nr: "n28", nr_num: 28, group: "Vorbereiten der Vergabe", kriterium: "Anforderung Produktsicherheitsgesetz beachten. (ProdSG, Gesetz über die Bereitstellung von Produkten auf dem Markt)", hinweise: "bspw. CE-Kennzeichnung, Inverkehrbringung ist geregelt, Zuständigkeiten für die Konformitätserklärung sind klar", lines: "L973",
  ...
  { nr: "n30", nr_num: 30, group: "Vorbereiten der Vergabe", kriterium: "Anforderungen zu Umlegungen von Straßen, Wegen, Änderungen der Verkehrsführung etc. sind im LV formuliert", hinweise: "Der Abschnitt 0 der VOB/C gibt hierzu weitere Hinweise", lines: "L978",
  ...
  { nr: "n31", nr_num: 31, group: "Vorbereiten der Vergabe", kriterium: "Die Leistungen sind umfassend und kalkulierbar beschrieben, die Randbedingungen sind genannt; der bauvertragliche Terminplan ist realistisch und enthält ggf. Freiheitsgrade, je nach Projektnotwendigkeiten", hinweise: "", lines: "L979",
  ...
  { nr: "n32", nr_num: 32, group: "Vorbereiten der Vergabe", kriterium: "Leitfabrikate, Standards, die in den Ausschreibungen eingesetzt werden, sind bewusst und den Anforderungen entsprechend festgelegt", hinweise: "In besonders zu begründenden Fällen", lines: "L980",
  ...
  { nr: "n33", nr_num: 33, group: "Vorbereiten der Vergabe", kriterium: "Leistungen, die aus Qualitätssicherungsplänen herrühren, sind ausgeschrieben, insbesondere bei risikobehafteten Maßnahmen", hinweise: "bspw. Bodenproben, Tragfähigkeitsprüfungen, Schweißnahtprüfung, Dichtheitsprüfungen etc.", lines: "L981",
  ...
  { nr: "n34", nr_num: 34, group: "Vorbereiten der Vergabe", kriterium: "Inbetriebnahmen, Probebetriebe etc. sind geplant und ausgeschrieben", hinweise: "Schnittstellen der Gewerke, Probebetriebsphasen", lines: "L982",
  ...
  { nr: "n35", nr_num: 35, group: "Vorbereiten der Vergabe", kriterium: "Prüfpflichtige Aggregate (bspw. Kompressoren mit TÜV-Prüfung) sind identifiziert Die Prüfungsleistung ist Bestandteil der Ausschreibung", hinweise: "", lines: "L983–L986",
  ...
  { nr: "n37", nr_num: 37, group: "Vorbereiten der Vergabe", kriterium: "Es liegt eine umfassende, passend zu den Gegebenheiten und zum Bauvorhaben bedarfsorientierte Baustellenordnung vor Die Verhaltensregeln sind transparent und verständlich beschrieben", hinweise: "Falls dies kalkulationsrelevant ist", lines: "L988–L991",
  ...
  { nr: "n40", nr_num: 40, group: "Mitwirken bei der Vergabe", kriterium: "Bauverträge sind vor Beginn der Ausschreibung (LPH 7) vollständig vorbereitet", hinweise: "AG-interne Fachbereiche sind beteiligt und haben zugeliefert", lines: "L1007",
  ...
  { nr: "n41", nr_num: 41, group: "Mitwirken bei der Vergabe", kriterium: "Zügige Beantwortung von Bieterfragen ist sichergestellt", hinweise: "", lines: "L1008",
    quote: "\\hline 41 & Zügige Beantwortung von Bieterfragen ist sichergestellt & \\\\" },
  { nr: "n42", nr_num: 42, group: "Mitwirken bei der Vergabe", kriterium: "Eignungskriterien werden sorgfältig geprüft Nicht geeignete Bieter werden ausgeschlossen", hinweise: "Der Preis ist für diesen Schritt regelmäßig nicht relevant", lines: "L1009",
  ...
  { nr: "n43", nr_num: 43, group: "Mitwirken bei der Vergabe", kriterium: "Die vom Bieter angebotenen Produkte entsprechen dem ausgeschriebenen Qualitätsstandard", hinweise: "Prüfen der Gleichwertigkeit oder der Erfüllung der Anforderungen an die Produkte", lines: "L1010",
  ...
  { nr: "n44", nr_num: 44, group: "Mitwirken bei der Vergabe", kriterium: "Formale Prüfung der Angebote; falls nicht bestanden → Ausschluss", hinweise: "", lines: "L1011",
    quote: "\\hline 44 & Formale Prüfung der Angebote; falls nicht bestanden → Ausschluss & \\\\" },
  { nr: "n45", nr_num: 45, group: "Mitwirken bei der Vergabe", kriterium: "Sachliche, fachtechnische, rechnerische Prüfung wird durchgeführt und dokumentiert; beide Seiten (Planer und AG) unterschreiben", hinweise: "Gegebenenfalls Aufklärungsgespräche führen", lines: "L1012",
  ...
  { nr: "n46", nr_num: 46, group: "Mitwirken bei der Vergabe", kriterium: "Prüfung und Wertung von Nebenangeboten und Alternativvorschlägen", hinweise: "", lines: "L1013",
    quote: "\\hline 46 & Prüfung und Wertung von Nebenangeboten und Alternativvorschlägen & \\\\" },
  { nr: "n47", nr_num: 47, group: "Mitwirken bei der Vergabe", kriterium: "Vergabevorschlag erarbeiten und AG vorlegen", hinweise: "", lines: "L1014",
    quote: "\\hline 47 & Vergabevorschlag erarbeiten und AG vorlegen & \\\\" },
  { nr: "n48", nr_num: 48, group: "Mitwirken bei der Vergabe", kriterium: "AG trifft die Zuschlagsentscheidung Nichtberücksichtigungsmitteilung wird an die Bieter versandt", hinweise: "", lines: "L1015",
    quote: "\\hline 48 & AG trifft die Zuschlagsentscheidung Nichtberücksichtigungsmitteilung wird an die Bieter versandt & \\\\" },
  { nr: "n49", nr_num: 49, group: "Mitwirken bei der Vergabe", kriterium: "Bindefrist bei der Vergabe berücksichtigen; ggf. rechtzeitig verlängern", hinweise: "Das Risiko einer Verlängerung ist jedoch, dass einzelne Bieter dem nicht zustimmen und sie dann an das Angebot nicht mehr gebunden sind", lines: "L1016",
  ...
  { nr: "n50", nr_num: 50, group: "Mitwirken bei der Vergabe", kriterium: "Zuschlag erteilen", hinweise: "Auf rechtlich wirksamen Vertragsabschluss achten!", lines: "L1017",
...
export const QE_B4_ITEMS: readonly QeItem[] = [
  { nr: "n1", nr_num: 1, group: null, kriterium: "Bürgerinformation findet zeitgerecht statt", hinweise: "", lines: "L1027",
    quote: "\\hline 1 & Bürgerinformation findet zeitgerecht statt & \\\\" },
  { nr: "n2", nr_num: 2, group: null, kriterium: "Verkehrslenkung wird in Zusammenarbeit mit den zuständigen Ämtern geklärt", hinweise: "Im Startgespräch berücksichtigen", lines: "L1028",
    quote: "\\hline 2 & Verkehrslenkung wird in Zusammenarbeit mit den zuständigen Ämtern geklärt & Im Startgespräch berücksichtigen \\\\" },
  { nr: "n3", nr_num: 3, group: null, kriterium: "Anlagen Dritter, bspw. Leitungen sind umzulegen oder zu schützen", hinweise: "Erforderliche Maßnahmen sind geklärt und werden umgesetzt", lines: "L1029",
  ...
  { nr: "n4", nr_num: 4, group: null, kriterium: "Beteiligung Dritter an den Projektschnittstellen", hinweise: "", lines: "L1030",
    quote: "\\hline 4 & Beteiligung Dritter an den Projektschnittstellen & \\\\" },
  { nr: "n5", nr_num: 5, group: null, kriterium: "Boden-, Naturdenkmale, Artenschutzmaßnahmen, Pflanzen- und Baumschutzmaßnahmen", hinweise: "Ansprechpartner sind bekannt Die ausgeschriebenen Maßnahmen werden koordiniert und in Abstimmung mit Behörden und Firmen umgesetzt", lines: "L1031–L1034",
  ...
  { nr: "n8", nr_num: 8, group: null, kriterium: "Umgang mit Gefahrstoffen wird geschult", hinweise: "Ausführliche Dokumentationen zu den Gefahrstoffen werden vor der Anwendung eingefordert und vorgelegt Beispielsweise sind in besonders schutzbedürftigen Bereichen besondere Einweisungen erforderlich", lines: "L1043–L1046",
  ...
  { nr: "n9", nr_num: 9, group: null, kriterium: "Die Auflagen des Genehmigungsbescheids sind bekannt und werden berücksichtigt", hinweise: "", lines: "L1047",
    quote: "\\hline 9 & Die Auflagen des Genehmigungsbescheids sind bekannt und werden berücksichtigt & \\\\" },
  { nr: "n10", nr_num: 10, group: null, kriterium: "Kampfmittelfreiheit ist vor Ausführungsbeginn hergestellt, die erforderlichen Freigaben liegen vor", hinweise: "Die Umsetzung der Maßnahmen und die Freigaben sind sorgfältig zu überwachen", lines: "L1048",
  ...
  { nr: "n14", nr_num: 14, group: null, kriterium: "Freigabefristen sind mit realistischer Dauer vereinbart", hinweise: "", lines: "L1071",
    quote: "\\hline 14 & Freigabefristen sind mit realistischer Dauer vereinbart & \\\\" },
  { nr: "n15", nr_num: 15, group: null, kriterium: "Abrechnungs- und Vertragsmodalitäten werden berücksichtigt (bspw. besondere Formulare des Auftraggebers)", hinweise: "", lines: "L1072",
    quote: "\\hline 15 & Abrechnungs- und Vertragsmodalitäten werden berücksichtigt (bspw. besondere Formulare des Auftraggebers) & \\\\" },
  { nr: "n16", nr_num: 16, group: null, kriterium: "Regelungen zur Leistungs- und Aufmaßfeststellung, und damit zur Abrechnung, sind geklärt", hinweise: "Falls Vorauszahlungen vereinbart werden, sind Vorauszahlungsbürgschaften vorzulegen", lines: "L1073",
  ...
  { nr: "n17", nr_num: 17, group: null, kriterium: "Bautagebücher (Bauüberwachung) und Bautagesberichte (Unternehmen) werden jeweils zeitnah vorgelegt oder angefordert", hinweise: "Umfang und Form sind vorab abzustimmen", lines: "L1074",
  ...
  { nr: "n22", nr_num: 22, group: null, kriterium: "Bei kleineren Maßnahmen können auch unangekündigte Vor-Ort-Termine von Bauüberwachung und ggf. SiGeKo sinnvoll sein", hinweise: "Falls der Überwachungsaufwand nicht sehr groß ist, kann sich das anbieten", lines: "L1101",
  ...
  { nr: "n24", nr_num: 24, group: null, kriterium: "Der Qualitätssicherungsplan wird von der Bauüberwachung konsequent umgesetzt", hinweise: "u. a. Betonüberwachung, Prüfpunkte während der Ausführung und vieles mehr", lines: "L1106",
  ...
  { nr: "n25", nr_num: 25, group: null, kriterium: "Die Projektbeteiligten dokumentieren und kennzeichnen aktuelle notwendige Provisorien, welche nach der Bauausführung entfernt werden: Fotodokumentation, beschreibende Ergänzung etc.", hinweise: "", lines: "L1107",
  ...
  { nr: "n26", nr_num: 26, group: null, kriterium: "Die Besprechungsarten und die Besprechungsregelungen sind festgelegt Gegebenenfalls kann der Bauherr in interner Runde mit dem Betrieb kommunizieren", hinweise: "", lines: "L1108",
  ...
  { nr: "n27", nr_num: 27, group: null, kriterium: "Baubesprechungen werden regelmäßig abgehalten und protokolliert Die Kommunikation der Ergebnisse ist sichergestellt (Firmen- und Bauherrenorganisation, inkl. Planungsbeteiligter)", hinweise: "", lines: "L1109–L1112",
  ...
  { nr: "n28", nr_num: 28, group: null, kriterium: "Es erfolgte eine durchgängige und stets aktuelle Überprüfung des bereits vertraglich vereinbarten Bauzeitenplans auf erforderliche Änderungen", hinweise: "", lines: "L1113",
  ...
  { nr: "n30", nr_num: 30, group: null, kriterium: "Es ist geklärt, wer auf der Seite der ausführenden Unternehmen Anordnungen des Auftraggebers empfangen darf", hinweise: "", lines: "L1118",
  ...
  { nr: "n33", nr_num: 33, group: null, kriterium: "Abnahmen und damit verbunden die Übergabe der Dokumentation sind strikt geregelt Die Zeitpunkte für die Abnahmen sind in der Inbetriebnahmeplanung enthalten", hinweise: "Dokumentation als wesentliche Grundlage für abnahmereife Leistungen", lines: "L1130",
...
export const QE_B5_ITEMS: readonly QeItem[] = [
  { nr: "n1", nr_num: 1, group: null, kriterium: "Wasserwirtschaftliche Abnahmen vor Inbetriebnahme", hinweise: "Mit Genehmigungsbehörden klären, abhängig von Anlage, Behörde etc.", lines: "L1141",
  ...
  { nr: "n2", nr_num: 2, group: null, kriterium: "Grundlage für dieses Phase ist die detaillierte Inbetriebnahmeplanung, die auch die Abnahmezeitpunkte geregelt hat", hinweise: "Betriebsphasen, Inbetriebnahmen, Außerbetriebnahmen, Abstimmung auf Anlagenbestand etc.", lines: "L1142",
  ...
  { nr: "n3", nr_num: 3, group: null, kriterium: "Die Ausarbeitung des Inbetriebnahmeorganigramms erfolgt durch den Bauherrn im Rahmen der Ausführung, rechtzeitig vor Inbetriebnahme", hinweise: "", lines: "L1143",
  ...
  { nr: "n4", nr_num: 4, group: null, kriterium: "Es fanden Vorbegehungen und Vorkontrollen (z. B. Montagekontrollen) der Anlagen statt Eine Aufklärung über den Gefahren- und Haftungsübergang vom Errichter bzw. Hersteller zum Nutzer bzw. Betreiber hat stattgefunden", hinweise: "", lines: "L1144",
  ...
  { nr: "n7", nr_num: 7, group: null, kriterium: "Einweisungen und Schulungen durch den Hersteller ermöglichen dem Betrieb, die Anlagen zu übernehmen", hinweise: "Die Schulungen können in verschiedenen Stufen vor oder nach der Abnahme erfolgen", lines: "L1156",
  ...
  { nr: "n8", nr_num: 8, group: null, kriterium: "Die Abnahmen werden durchgeführt", hinweise: "Die Zeitpunkte der Abnahme der einzelnen Gewerke sind geplant und auf die Inbetriebnahmeszenarien abgestimmt", lines: "L1157",
...
export const QE_B6_ITEMS: readonly QeItem[] = [
  { nr: "n1", nr_num: 1, group: null, kriterium: "As-built-Modell wird erstellt Datenübergabe erfolgt an den Betrieb zur Weiternutzung Der Betrieb führt den digitalen Bestand im Idealfall mit digitalen Wartungsplänen fort", hinweise: "Ergänzungen siehe 7.2", lines: "L1174",
  ...
  { nr: "n5", nr_num: 5, group: null, kriterium: "Kaufmännischer und finanzieller Abschluss der Projekte erfolgt, bevor die Buchhaltung die Aktivierung durchführen kann Es findet ein Kostenabschluss des Projekts statt", hinweise: "", lines: "L1185–L1188",
  ...
  { nr: "n6", nr_num: 6, group: null, kriterium: "Die Inhalte der Dokumentenbedarfsliste werden abgearbeitet, zusammengestellt und übergeben", hinweise: "", lines: "L1189",
...
export function qeCatalogueAsTable(cat: QeCatalogue): RegulationTable {
  const rows: RegulationRow[] = cat.items.map((it, i) => ({
    row_key: it.nr, keys: { nr: it.nr }, group_label: it.group, label_de: `${it.nr_num} · ${inSpan(it.kriterium, it.quote, `${cat.code} ${it.nr} kriterium`)}`, order_index: i,
