...
export default function LoginPage() {
  ...
  return (
    <div className="grid place-items-center min-h-[calc(100dvh-6rem)] lg:min-h-[calc(100dvh-8rem)]">
      <div className="w-full max-w-sm border border-hairline bg-paper-2/30 p-8 space-y-6 relative">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <h1 className="font-display text-2xl text-ink">{t('signIn')}</h1>
