...
> Its own `title_de` in prod says it is derived from the 2017 scoping report and
> explicitly NOT the published ISO 14097:2021; the only PDF on disk is that scoping
> report. Non-normative source means VA is unreachable; cap at VC until the published
> standard is located.
