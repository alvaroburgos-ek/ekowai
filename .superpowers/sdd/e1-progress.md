...
- **FLL-GAR bring-up — plan: vault 2026-07-13-FLL-GAR-bringup-plan.md (approved, profile route for Gl.2b).**
  ...
  - REMAINING (per plan): project setup (add FLL-GAR-2023 to a test project → instantiate 29 worksheets), field-verification sweep, acceptance run (predictions-first, discriminating values, DB decides). Exit assertion: ZERO engine/dispatch/gate changes.
